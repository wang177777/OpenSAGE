...
```
Dynamic Guideline: WHO-Based Diphtheria - Diagnosis and/or Treatment and/or Management
```
...
## II. Evidence Summary After WHO Latest Guideline Release (Clinical management of diphtheria: guideline) (Evidence Cutoff Date: DD Month YYYY)
...
**Generate the complete report for Diphtheria following all requirements above.**
