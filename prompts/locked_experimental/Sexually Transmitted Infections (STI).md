...
```
Dynamic Guideline: WHO-Based Sexually Transmitted Infections (STI) - Diagnosis and/or Treatment and/or Management
```
...
## II. Evidence Summary After WHO Latest Guideline Release (Guidelines on lenacapavir for HIV prevention and testing strategies for long-acting injectable pre-exposure prophylaxis) (Evidence Cutoff Date: DD Month YYYY)
...
**Generate the complete report for Sexually Transmitted Infections (STI) following all requirements above.**
