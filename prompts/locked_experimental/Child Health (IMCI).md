...
```
Dynamic Guideline: WHO-Based Child Health (IMCI) - Diagnosis and/or Treatment and/or Management
```
...
## II. Evidence Summary After WHO Latest Guideline Release (WHO recommendations on child health: guidelines approved by the WHO Guidelines Review Committee) (Evidence Cutoff Date: DD Month YYYY)
...
**Generate the complete report for Child Health (IMCI) following all requirements above.**
