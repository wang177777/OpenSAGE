...
```
Dynamic Guideline: WHO-Based Ebola - Diagnosis and/or Treatment and/or Management
```
...
## II. Evidence Summary After WHO Latest Guideline Release (Infection prevention and control guideline for Ebola and Marburg disease, August 2023) (Evidence Cutoff Date: DD Month YYYY)
...
**Generate the complete report for Ebola following all requirements above.**
