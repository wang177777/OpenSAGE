...
```
Dynamic Guideline: WHO-Based SARS - Diagnosis and/or Treatment and/or Management
```
...
## II. Evidence Summary After WHO Latest Guideline Release (WHO guidelines for the global surveillance of severe acute respiratory syndrome (SARS): updated recommendations) (Evidence Cutoff Date: DD Month YYYY)
...
**Generate the complete report for SARS following all requirements above.**
