...
```
Dynamic Guideline: WHO-Based Cancer - Diagnosis and/or Treatment and/or Management
```
...
## II. Evidence Summary After WHO Latest Guideline Release (WHO guideline for screening and treatment of cervical pre-cancer lesions for cervical cancer prevention) (Evidence Cutoff Date: DD Month YYYY)
...
**Generate the complete report for Cancer following all requirements above.**
