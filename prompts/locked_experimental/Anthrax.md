...
```
Dynamic Guideline: WHO-Based Anthrax - Diagnosis and/or Treatment and/or Management
```
...
## II. Evidence Summary After WHO Latest Guideline Release (Guidelines for the Surveillance and Control of Anthrax in Humans and Animals) (Evidence Cutoff Date: DD Month YYYY)
...
**Generate the complete report for Anthrax following all requirements above.**
