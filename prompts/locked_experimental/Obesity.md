...
```
Dynamic Guideline: WHO-Based Obesity - Diagnosis and/or Treatment and/or Management
```
...
## II. Evidence Summary After WHO Latest Guideline Release (Total fat intake for the prevention of unhealthy weight gain in adults and children: WHO guideline) (Evidence Cutoff Date: DD Month YYYY)
...
**Generate the complete report for Obesity following all requirements above.**
