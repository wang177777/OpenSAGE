...
```
Dynamic Guideline: WHO-Based Hypertension - Diagnosis and/or Treatment and/or Management
```
...
## II. Evidence Summary After WHO Latest Guideline Release (Guideline for the pharmacological treatment of hypertension in adults: summary) (Evidence Cutoff Date: DD Month YYYY)
...
**Generate the complete report for Hypertension following all requirements above.**
