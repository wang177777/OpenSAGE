...
```
Dynamic Guideline: WHO-Based Hepatitis - Diagnosis and/or Treatment and/or Management
```
...
## II. Evidence Summary After WHO Latest Guideline Release (Consolidated guidelines on person-centred viral hepatitis strategic information: using data to support) (Evidence Cutoff Date: DD Month YYYY)
...
**Generate the complete report for Hepatitis following all requirements above.**
