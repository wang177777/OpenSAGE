...
```
Dynamic Guideline: WHO-Based Leishmaniasis - Diagnosis and/or Treatment and/or Management
```
...
## II. Evidence Summary After WHO Latest Guideline Release (Guideline for the treatment of Leishmaniasis in the Americas. Second edition（丢失）) (Evidence Cutoff Date: DD Month YYYY)
...
**Generate the complete report for Leishmaniasis following all requirements above.**
