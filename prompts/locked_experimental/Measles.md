...
```
Dynamic Guideline: WHO-Based Measles - Diagnosis and/or Treatment and/or Management
```
...
## II. Evidence Summary After WHO Latest Guideline Release (Guidelines on verification of measles elimination in the Western Pacific Region. 2nd ed.) (Evidence Cutoff Date: DD Month YYYY)
...
**Generate the complete report for Measles following all requirements above.**
