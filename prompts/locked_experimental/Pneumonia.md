...
```
Dynamic Guideline: WHO-Based Pneumonia - Diagnosis and/or Treatment and/or Management
```
...
## II. Evidence Summary After WHO Latest Guideline Release (Guideline on management of pneumonia and diarrhoea in children up to 10 years of age) (Evidence Cutoff Date: DD Month YYYY)
...
**Generate the complete report for Pneumonia following all requirements above.**
