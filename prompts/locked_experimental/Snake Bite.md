...
```
Dynamic Guideline: WHO-Based Snake Bite - Diagnosis and/or Treatment and/or Management
```
...
## II. Evidence Summary After WHO Latest Guideline Release (Guidelines for the management of snakebites, 2nd edition) (Evidence Cutoff Date: DD Month YYYY)
...
**Generate the complete report for Snake Bite following all requirements above.**
