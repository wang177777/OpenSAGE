...
```
Dynamic Guideline: WHO-Based Tungiasis - Diagnosis and/or Treatment and/or Management
```
...
## II. Evidence Summary After WHO Latest Guideline Release (Guidelines for the treatment of tungiasis（丢失）) (Evidence Cutoff Date: DD Month YYYY)
...
**Generate the complete report for Tungiasis following all requirements above.**
