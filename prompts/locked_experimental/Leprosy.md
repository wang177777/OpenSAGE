...
```
Dynamic Guideline: WHO-Based Leprosy - Diagnosis and/or Treatment and/or Management
```
...
## II. Evidence Summary After WHO Latest Guideline Release (Guidelines for the diagnosis, treatment and prevention of leprosy) (Evidence Cutoff Date: DD Month YYYY)
...
**Generate the complete report for Leprosy following all requirements above.**
