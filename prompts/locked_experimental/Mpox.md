...
```
Dynamic Guideline: WHO-Based Mpox - Diagnosis and/or Treatment and/or Management
```
...
## II. Evidence Summary After WHO Latest Guideline Release (Clinical management and infection prevention and control for mpox: living guideline, May 2025) (Evidence Cutoff Date: DD Month YYYY)
...
**Generate the complete report for Mpox following all requirements above.**
