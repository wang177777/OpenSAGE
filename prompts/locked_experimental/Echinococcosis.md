...
```
Dynamic Guideline: WHO-Based Echinococcosis - Diagnosis and/or Treatment and/or Management
```
...
## II. Evidence Summary After WHO Latest Guideline Release (WHO guidelines for the treatment of patients with cystic echinococcosis) (Evidence Cutoff Date: DD Month YYYY)
...
**Generate the complete report for Echinococcosis following all requirements above.**
